...
export default function Work() {
  ...
  return (
    <section
      id="work"
      className="relative z-10 border-t border-brand-gray/10 bg-[#f9f9f9] py-24 dark:border-white/10 dark:bg-[#0a0a0a]"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="col-span-12 lg:col-span-8 group border-2 sm:border-4 border-brand-gray dark:border-white bg-white dark:bg-[#0c0c0c] text-brand-gray dark:text-brand-light overflow-hidden rounded-3xl shadow-xl hover:shadow-brand-aqua/10 transition-all duration-300">
          ...
          <div className="col-span-12 lg:col-span-4 bg-brand-aqua text-black p-6 sm:p-8 flex flex-col justify-between rounded-3xl shadow-xl hover:bg-brand-lime transition-colors duration-500 min-h-[320px] lg:min-h-full">
          ...
          {caseStudies.slice(1).map((project) => (
            <div
              key={project.id}
              className="col-span-12 md:col-span-6 group border-2 sm:border-4 border-brand-gray dark:border-white bg-white dark:bg-[#0c0c0c] text-brand-gray dark:text-brand-light overflow-hidden rounded-3xl shadow-xl hover:shadow-brand-aqua/10 transition-all duration-300"
            >
          ...
          <div
            ...
            className="col-span-12 bg-white dark:bg-[#0c0c0c] text-brand-gray dark:text-[#f9f9f9] border-2 sm:border-4 border-brand-gray dark:border-white p-6 sm:p-12 flex flex-col justify-center items-center rounded-3xl shadow-xl relative overflow-hidden group cursor-pointer"
          >
      ...
      {selectedCase && (
        <div
          id="case-study-modal"
          className="fixed inset-0 z-50 flex items-center justify-end bg-black/85 p-4"
        >
          <div className="absolute inset-0" onClick={() => setSelectedCase(null)} aria-hidden />

          <div className="relative z-10 flex h-[90vh] w-full max-w-xl flex-col overflow-hidden rounded-3xl border-2 border-brand-gray bg-white text-brand-gray shadow-2xl sm:border-4 dark:border-white dark:bg-[#0c0c0c] dark:text-brand-light">
            {/* Header controls */}
